...
function actionAjoutauteur($twig, $db){
 ...
 $form['valide'] = true;
 $form['messageTitre'] = 'Auteur ajoutée';
 $form['message'] = 'Le libelle pour Auteur a bien été ajouter !';

 $exec = $auteur->insert($nomauteur,$prenomauteur,$biographieauteur);
 if (!$exec){
   $form['messageTitre'] = 'Echec de l\'ajout';
   $form['message'] = 'Le libelle pour Auteur na pas put être ajouté !';
 }
 }
...
function actionAjoutediteur($twig, $db){
 ...
 $form['valide'] = true;
 $form['messageTitre'] = 'Editeur ajoutée';
 $form['message'] = 'Le libelle pour Editeur a bien été ajouter !';

 $exec = $editeur->insert($nomediteur);
 if (!$exec){
 $form['valide'] = false;
 $form['messageTitre'] = 'Echec de l\'ajout';
 $form['message'] = 'Le libelle pour Editeur na pas put être ajouté !';
 }
 }
...
function actionAjoutdisponibilite($twig, $db){
 ...
 $form['valide'] = true;
 $form['messageTitre'] = 'Disponibilité ajoutée';
 $form['message'] = 'Le libelle pour disponibilité a bien été ajouter !';

 $exec = $disponibilite->insert($libelle);
 if (!$exec){
 $form['valide'] = false;
 $form['messageTitre'] = 'Echec de l\'ajout';
 $form['message'] = 'Le libelle pour disponibilité na pas put être ajouté !';
 }
 }
  $liste = $disponibilite->select();
...
function actionAjoutcollection($twig, $db){
 ...
 $form['valide'] = true;
 $form['messageTitre'] = 'Collection ajoutée';
 $form['message'] = 'Le libelle pour Collection a bien été ajouter !';

 $exec = $collection->insert($libellecollection);
 if (!$exec){
 $form['valide'] = false;
 $form['messageTitre'] = 'Echec de l\'ajout';
 $form['message'] = 'Le libelle pour Collection na pas put être ajouté !';
 }
 }
...
function actionAjoutlivre($twig, $db){
  ...
  $auteur = new Auteur($db);
  $editeur = new Editeur($db);
  $coupdecoeur = new Coupdecoeur($db);
  if (isset($_POST['btAjouter'])){
 ...
 $idcoupdecoeur = $_POST['inputIdcoupdecoeur'];

 $form['valide'] = true;
 $form['messageTitre'] = 'Livre ajoutée';
 $form['message'] = 'Le libelle pour Livre a bien été ajouter !';

 $exec = $livre->insert($couverture,$titre,$idauteur,$idediteur,$datelivre,$isbn,$prix,$iddisponibilite,$idcollection,$idgenre,$idcoupdecoeur);
 if (!$exec){
 $form['valide'] = false;
 $form['messageTitre'] = 'Echec de l\'ajout';
 $form['message'] = 'Le libelle pour Livre na pas put être ajouté !';
 }
 }
  ...
  $listef = $coupdecoeur->select();
  // $listecdc = $coupdecoeur->select();
echo $twig->render('adminajoutlivre.html.twig', array('form'=>$form,'liste'=>$liste,'listeg'=>$listeg,'listec'=>$listec,'listed'=>$listed,'listea'=>$listea,'listee'=>$listee,'listef'=>$listef));
}
function actionAjoutevent($twig, $db){
 ...
 $form['valide'] = true;
 $form['messageTitre'] = 'Event ajoutée';
 $form['message'] = 'Le libelle pour Event a bien été ajouter !';

 $exec = $event->insert($titre,$information,$illustration);
 if (!$exec){
   $form['messageTitre'] = 'Echec de l\'ajout';
   $form['message'] = 'Le libelle pour Event na pas put être ajouté !';
 }
 }
...
function actionModifcollection($twig, $db){
  ...
  if ($unCollection!=null){$form['collection'] = $unCollection;}
    ...
    $form['messageTitre'] = 'Echec de la Modification';
    $form['message'] = 'Le libelle pour Collection na pas put être modifier !';
    }
  }
  else{
  ...
  $form['valide'] = true;
  $form['messageTitre'] = 'Collection modifier';
  $form['message'] = 'Le libelle pour Collection a bien été modifier !';
